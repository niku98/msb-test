...
const LayerSwitch = ({ className }: LayerSwitchProps) => {
  return (
    <svg
      ...
      className={className}
    >
      <g clipPath="url(#clip0_1_3415)">
        <path
          d="M29.5013 35.8335L27.0013 33.3335L29.5013 30.8335"
          stroke="currentColor"
          strokeWidth="2"
          strokeLinecap="round"
        ...
        />
        <path
          d="M11.1653 4.1665L13.6653 6.6665L11.1653 9.1665"
          stroke="currentColor"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
